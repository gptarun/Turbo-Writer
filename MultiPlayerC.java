...
public class MultiPlayerC extends JFrame implements KeyListener,Runnable
	 {
  		JLabel l_road,l_road1,l_car,l_car1,l_bg,l_word,l_word1,l_flag,l_flag1;
		Image i,i2;
  		JTextArea ta_para;   
 		JTextField tf_type;
		Highlighter hilite;
		...
		public static void main(String args[])
 		{
  			MultiPlayerC p = new MultiPlayerC();
		...
		public void type()
 		{
			...
			l_car1 = new JLabel(new ImageIcon("car3.png"));
  			...
  			l_bg.add(l_car);		
			l_car1.setBounds(Client.location,175,57,25);	
		...
		public void run() {
			while(true) {
				l_word1.setText("wpm = " + Client.wppm);
				l_car1.setBounds(Client.location,175,57,25);
			}		
		}
